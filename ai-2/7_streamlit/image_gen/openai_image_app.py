...
#     image_size = st.sidebar.radio('생성할 이미지 크기를 선택해주세요', image_size_options, index=0, horizontal=True)
#     detail_description = st.sidebar.radio('상세 묘사를 추가하는가요?', ['Yes','No'], index=1, horizontal=True)
