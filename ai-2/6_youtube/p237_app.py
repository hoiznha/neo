...
srt_formatterd = srt_formatter.format_transcript(transcript)
print(srt_formatterd[:150])
print('-'*70)
...
srt_file = f'{download_foler}/{video_id}.srt'
print(' - SRT 파일 저장 :', srt_file)
with open(srt_file, 'w', encoding='utf-8') as f:
    f.write(srt_formatterd)

text_file = f'{download_foler}/{video_id}.txt'
