...
filename = 'p434_alice_Gaph02.png'
plt.savefig(filename,dpi=400,bbox_inches='tight')
print(filename+ ' saved')
...
wc = WordCloud(background_color='white',mask=alice_color_mask,
               stopwords=mystopwords,max_words=2000,max_font_size=40,random_state=42)
wc = wc.generate(text)
...
filename = 'p434_alice_Gaph03.png'
plt.savefig(filename,dpi=400,bbox_inches='tight')
print(filename+ ' saved')
...
filename = 'p434_alice_Gaph04.png'
plt.savefig(filename,dpi=400,bbox_inches='tight')
print(filename+ ' saved')
...
filename = 'p434_alice_Gaph05.png'
plt.savefig(filename,dpi=400,bbox_inches='tight')
print(filename+ ' saved')
