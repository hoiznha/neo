...
# font_location = '~/.virtualenvs/neo/lib/python3.12/site-packages/matplotlib/mpl-data/fonts/ttf/NanumBarunGothic.ttf'
...
print('집계 함수를 dicth에 담아 전달')
print('지역 개수와 상영 횟수의 총합')
...
print('groupby 와 사용자 정의 함수 사용(매개변수 2개 사용')
result = mygrouping.agg(plus_add,somevalue=3)
print(result)
print('-'*5)

print('columns 2개 이상 그룹핑하기')
