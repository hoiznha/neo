...
#titles preview site : https://leaflet-extra.github.io/leaflet-providers-preview/
map_osm.save('xx_map3.html')

map_osm = folium.Map(location=[latitude, longitude], zoom_start=17)
folium.Marker([latitude,longitude],popup='서울특별시청').add_o(map_osm)
map_osm.save('xx_map4.html')

map_osm = folium.Map(location=[latitude, longitude], zoom_start=17)
folium.Marker([latitude,longitude],popup='서울특별시청', icon=folium.Icon(color='red',icon='info')).add_o(map_osm)
